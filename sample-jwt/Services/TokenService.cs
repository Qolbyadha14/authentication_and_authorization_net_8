...
namespace sample_jwt.Services
{
    public class TokenService
    {
        ...
        public string CreateToken(ApplicationUser user)
        {
            ...
            var user_claim = CreateClaims(user);
            var create_credentials =  CreateSigningCredentials();
            var token = CreateJwtToken(user_claim, create_credentials, expiration);
